"""
Evaluation metrics calculation for segmentation baseline experiment.
Computes accuracy, balanced accuracy, macro/weighted precision, recall, F1, and confusion matrices.
"""
